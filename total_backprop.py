...
def main(argv=None):
    ...
    with tf.variable_scope(FLAGS.model_name):
        ...
        vanilla_model = dataset.load_model_by_name(FLAGS.model_name, logits=False, input_range_type=1)
    ...
    Y_pred_all = vanilla_model.predict(X_test_all)
    ...
    if FLAGS.robustness != '':
        ...
        evaluate_robustness(FLAGS.robustness, vanilla_model, Y_test_all, X_test_all, Y_test, \
