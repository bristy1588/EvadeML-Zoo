"""
    ...
    Self: Notes:
        ...
        - Only done for Linf attack : Works only for PGD Linf only
...
flags.DEFINE_string('filter', '', 'Supported: bit_depth')
...
def main(argv=None):
    ...
    from attacks import maybe_bpda_generate_adv_examples
